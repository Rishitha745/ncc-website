  ...
  const scrollToThumbnail = (index) => {
    if (thumbnailRef.current) {
      if (thumbnailRef.current) {
        ...
        const centerPosition = targetScroll - containerWidth / 2 + thumbnailWidth / 2;
    ...
    <div>
      <MainLayout>
        <div className="relative ">
          ...
          <div className="relative h-24 md:h-36 w-full md:w-1/2 flex-col bg-zinc-700 items-center justify-center md:mx-auto shadow-lg rounded-lg mb-6 md:mb-8">
            ...
            <div ref={thumbnailRef} className="overflow-x-auto scroll-smooth ">
              <div className="inline-flex gap-4">
                {data.map(({ imgelink }, slideIndex) => (
                  <div key={slideIndex} className={`h-28 w-36 overflow-hidden transition-transform duration-300 ease-in-out ${
